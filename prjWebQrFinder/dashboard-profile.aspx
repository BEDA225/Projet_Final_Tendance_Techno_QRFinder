<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAccueilUser.Master" AutoEventWireup="true" CodeBehind="dashboard-profile.aspx.cs" Inherits="prjWebQrFinder.dashboard_profile" %>
   ...
   <aside class="dash-aside-navbar">
		<div class="position-relative">
			...
			<div class="user-data">
				...
				<div class="user-name-data">
					...
					<ul class="dropdown-menu" aria-labelledby="profile-dropdown">
					    <li>
                            <a class="dropdown-item d-flex align-items-center" href="dashboard-profile.aspx"><img src="../images/lazy.svg" data-src="images/icon/icon_23.svg" alt="" class="lazy-img"><span class="ms-2 ps-1">Profile</span></a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="dashboard-settings.aspx"><img src="../images/lazy.svg" data-src="images/icon/icon_24.svg" alt="" class="lazy-img"><span class="ms-2 ps-1">Parametres du Compte</span></a>
                        </li>
                        <li>
			...
			<nav class="dasboard-main-nav">
				<ul class="style-none">
					<li><a href="accueilUtilisateursQrFinder.aspx" class="d-flex w-100 align-items-center active">
						<img src="../images/lazy.svg" data-src="images/icon/icon_1_active.svg" alt="" class="lazy-img">
						<span>Dashboard</span>
					</a></li>
					<li><a href="dashboard-profile.aspx" class="d-flex w-100 align-items-center">
						<img src="../images/lazy.svg" data-src="images/icon/icon_2.svg" alt="" class="lazy-img">
						<span>Profile</span>
					</a></li>
					
					<li><a href="dashboard-message.aspx" class="d-flex w-100 align-items-center">
						<img src="../images/lazy.svg" data-src="images/icon/icon_4.svg" alt="" class="lazy-img">
						<span>Messages</span>
					</a></li>
					<li><a href="dashboard-alert.aspx" class="d-flex w-100 align-items-center">
						<img src="../images/lazy.svg" data-src="images/icon/icon_5.svg" alt="" class="lazy-img">
						<span>Alerte Objet</span>
					</a></li>
					
					<li><a href="dashboard-settings.aspx" class="d-flex w-100 align-items-center">
			...
			<div class="position-relative">
				...
				<header class="dashboard-header">
					<div class="d-flex align-items-center justify-content-end">
						...
						<div><a href="DeclarerObjets.aspx" class="job-post-btn tran3s">Declarer un objet</a></div>
					</div>
				</header>
				<!-- End Header -->
